...
public class RobotMap {
    ...
    public static void init() {
        ...
        driveTrainCANTalonFL = new CANTalon(0);
        ...
        driveTrainCANTalonBL = new CANTalon(2);
        ...
        driveTrainRobotDrive = new RobotDrive(driveTrainCANTalonFL, driveTrainCANTalonBL,
              driveTrainCANTalonFR, driveTrainCANTalonBR);
        ...
        winchWinchTop = new CANTalon(5);
        LiveWindow.addActuator("Winch", "WinchTop", winchWinchTop);
        
        winchWinchBottom = new CANTalon(6);
