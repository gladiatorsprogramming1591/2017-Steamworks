...
public class RobotMap {
    ...
    public static Relay gearLiftLiftSpike;
    public static DigitalInput gearLiftUpperLimitLift;
    public static DigitalInput gearLiftLowerLimitLift;
    ...
    public static void init() {
        ...
        gearLiftLiftSpike = new Relay(1);
        LiveWindow.addActuator("GearLift", "LiftSpike", gearLiftLiftSpike);
        
        gearLiftUpperLimitLift = new DigitalInput(11);
        LiveWindow.addSensor("GearLift", "UpperLimitLift", gearLiftUpperLimitLift);
        
        gearLiftLowerLimitLift = new DigitalInput(10);
        LiveWindow.addSensor("GearLift", "LowerLimitLift", gearLiftLowerLimitLift);
