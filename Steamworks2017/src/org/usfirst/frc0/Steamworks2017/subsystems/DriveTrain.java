...
public class DriveTrain extends PIDSubsystem {
    ...
    protected void usePIDOutput(double output) {
        ...
        speedControllerFL.pidWrite(output);

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=OUTPUT
    }

	public void driving(Joystick driveStick, double rotation) {
		robotDrive.mecanumDrive_Cartesian(driveStick.getX(),driveStick.getY() ,rotation ,0);
	}
